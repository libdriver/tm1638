...
TM1638은 LED(발광 다이오드 디스플레이) 구동 제어 전용 IC이며 키패드 스캔 인터페이스를 갖추고 있습니다. MCU 디지털 인터페이스, 데이터 래치, LED 드라이브 및 키패드 스캐닝 회로가 통합되어 있습니다. 이 제품은 품질이 안정적이고 성능이 안정적이며 간섭 저항이 강합니다. 주로 가정용 전기 제품(스마트 온수기, 전자레인지, 세탁기, 에어컨, 전기 스토브), 셋톱박스, 전자 저울, 스마트 미터 및 기타 디지털 튜브 또는 LED 디스플레이 장치에 사용됩니다.

LibDriver TM1638은 LibDriver가 출시한 TM1638의 전체 기능 드라이버입니다. LibDriver TM1638은 디지털 튜브 디스플레이, 키패드 스캐닝 및 기타 기능을 제공합니다. LibDriver는 MISRA를 준수합니다.
...
/src 디렉토리에는 LibDriver TM1638의 소스 파일이 포함되어 있습니다.

/interface 디렉토리에는 LibDriver TM1638용 플랫폼 독립적인 SPI버스 템플릿이 포함되어 있습니다.

/test 디렉토리에는 LibDriver TM1638드라이버 테스트 프로그램이 포함되어 있어 칩의 필요한 기능을 간단히 테스트할 수 있습니다.

/example 디렉토리에는 LibDriver TM1638프로그래밍 예제가 포함되어 있습니다.

/doc 디렉토리에는 LibDriver TM1638오프라인 문서가 포함되어 있습니다.

/datasheet 디렉토리에는 TM1638데이터시트가 있습니다.
...
온라인 문서: [https://www.libdriver.com/docs/tm1638/index.html](https://www.libdriver.com/docs/tm1638/index.html).
